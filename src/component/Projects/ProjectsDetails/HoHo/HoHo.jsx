          ...
          <div className="hoho-project-left">
            <div className="hoho-project-left-desc">
              ...
              <div className="hoho-project-techno">
                <img className="hoho-project-left-techno-icon" src="/icons/react-native.svg" alt="react native" />
                <img className="hoho-project-left-techno-icon" src="/icons/google-cloud.svg" alt="google cloud plateform" />
                <img className="hoho-project-left-techno-icon elastic" src="/icons/elastic.svg" alt="elasticsearch" />
